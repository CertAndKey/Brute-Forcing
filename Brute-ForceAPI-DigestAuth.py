...
for api in file:
    ...
    #POSTS
    print("POST "+ url_full)
    r = requests.post(url_full, auth=HTTPDigestAuth('<username>','<password>'))
    print(r.status_code)
    
    #PUTS
    print("PUT "+ url_full)
    r = requests.put(url_full, auth=HTTPDigestAuth('<username>','<password>'))
    print(r.status_code)
    
    #PATCHES
    print("PATCH "+ url_full)
    r = requests.patch(url_full, auth=HTTPDigestAuth('<username>','<password>'))
    print(r.status_code)
